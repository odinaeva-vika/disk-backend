...
class FileController {
    ...
    async getFiles(req, res) {
        try {
            ...
            console.log(e)
            return res.status(500).json({message: "Не получается получить файлы"})
        }
    }
    ...
    async uploadAvatar(req, res) {
        try {
            ...
            console.log(e)
            return res.status(400).json({message: 'Ошибка загрузки иконки'})
        }
    }
    ...
    async deleteAvatar(req, res) {
        try {
            ...
            console.log(e)
            return res.status(400).json({message: 'Ошибка удаления иконки'})
        }
    }
}
